"""Evaluation logic for the Hypo3D task."""
...
from data.data_utils import Hypo3DAnswer
from evaluator.common.build import EVALUATOR_REGISTRY


@EVALUATOR_REGISTRY.register()
class Hypo3DEval():
    """Evaluator for Hypo3D answer classification."""
    ...
    def __init__(self, cfg, task_name):
        ...
        self.answer_vocab = Hypo3DAnswer(answer_cands)
        color_terms = [
            "black",
            "blue",
            "brown",
    ...
    def update(self, data_dict):
        """Accumulate one batch of Hypo3D predictions."""
